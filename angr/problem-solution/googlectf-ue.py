...
def main():
    ...
    initial_state.libc.buf_symbolic_bytes=input_size + 1 # Thanks to Christopher Salls (@salls) for pointing this out. 
    ...
    path_group.explore(find=0x40083e, avoid=0x400850)
